...
const IncomeForm = () => {
  ...
  if (loading && isEdit) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="rounded-full h-12 w-12 border-b-2 border-blue-500 animate-spin"></div>
      </div>
    );
  }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  min="0"
                  required
                  className="pl-8 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                  placeholder="0.00"
                  disabled={loading}
                />
              </div>
