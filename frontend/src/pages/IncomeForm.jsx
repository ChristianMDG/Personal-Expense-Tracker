  ...
  return (
    <div className="min-h-full bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl">
        ...
        {error && (
          <div 
            className="mb-6 flex items-center rounded-lg p-4 bg-red-50 border border-red-200 text-red-800"
            style={{ 
        ...
        {success && (
          <div 
            className="mb-6 flex items-center rounded-lg p-4 bg-green-50 border border-green-200 text-green-800"
            style={{ 
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              disabled={loading}
              placeholder="0.00"
              className="w-full rounded-lg border border-gray-300 px-4 py-3 pl-3 outline-none focus:border-transparent focus:ring-2 focus:ring-[var(--accent-color)] transition-all duration-200"
              style={{ transition: "all 0.2s ease" }}
            />
            {formData.amount && (
              <p 
          ...
          <div>
            ...
            <input
              ...
              required
              disabled={loading}
              className="w-full rounded-lg border border-gray-300 px-4 py-3 outline-none focus:border-transparent focus:ring-2 focus:ring-[var(--accent-color)] transition-all duration-200"
              style={{ transition: "all 0.2s ease" }}
            />
          </div>
          ...
          <div className="flex flex-col gap-3 pt-4 sm:flex-row">
            <button
              type="submit"
              disabled={loading}
              className="flex flex-1 items-center justify-center rounded-lg bg-[var(--primary-color)] px-6 py-3 font-medium text-white hover:bg-[var(--secondary-color)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-color)] focus:ring-offset-2 disabled:opacity-50 transition-all duration-200"
              style={{ transition: "all 0.2s ease" }}
            >
              {loading ? (
            ...
            <button
              ...
              onClick={() => navigate("/incomes")}
              disabled={loading}
              className="flex-1 rounded-lg border border-gray-300 px-6 py-3 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 transition-all duration-200"
              style={{ transition: "all 0.2s ease" }}
            >
              Cancel
            </button>
