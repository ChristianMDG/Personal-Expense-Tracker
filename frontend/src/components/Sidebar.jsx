...
const Sidebar = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      ...
      {/* Sidebar */}
      <aside className="bg-[var(--primary-color)] text-black md:w-64 md:min-h-screen w-full md:sticky md:top-0 md:h-screen">
        {/* Logo Section */}
        <div className="p-6 border-b border-[var(--secondary-color)]">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Planifieo</h1>
        ...
        <nav className="p-4 space-y-1">
          {menuItems.map((item) => (
            ...
            >
              <span className={`transition-colors duration-200 ${isActive(item.path) ? 'text-black' : 'text-blue-200 group-hover:text-black'
                }`}>
                {item.icon}
              </span>
        ...
        {/* User Section & Logout */}
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-[var(--secondary-color)] bg-[var(--primary-color)]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-white bg-opacity-10 hover:bg-opacity-20 text-black rounded-lg transition-all duration-200 hover:shadow-md group"
          >
